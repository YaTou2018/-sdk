...
//      whiteboardInstance.lc.on("lc-pointerdrag",whiteboardInstance.lcPointerdragEvent) ;
    ...
    /*设置白板的图片*/
    setWhiteboardWatermarkImage(id ,watermarkImageUrl , {resetDedaultWhiteboardMagnification = true , loadSucceedCallback , loadFailureCallback, timeoutCallback } = {} ){
        const that = this ;
        ...
        if(!watermarkImageUrl){ //图片地址没有，则使用默认白板
            ...
            if(that.getFileExt(watermarkImageUrl) == '.pdf' && PDFObject.supportsPDFs && window.PDFObject){
    ...
    _updateWhiteboardFiledata(whiteboardInstance , filedata){
        if(filedata && typeof filedata === 'object'){
            ...
            whiteboardInstance.filedata.baseurl = filedata.baseurl;
